...
public class PClientes extends JPanel {
	...
	private void atualizarRedimensionamento(Component frame, Component scrollPane) {
	...
	public void setTableModel(TClientes model) {
		this.table.setModel(model);
	}

	public void getColumn(int index, int width) {
